...
import shoppingListExporterFields from 'src/app/shopping-list/list/shopping-list-exporter-fields';
...
export class ShoppingListListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
