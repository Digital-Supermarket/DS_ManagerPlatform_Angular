...
/**
 * Handles ShoppingList operations
 */
module.exports = class ShoppingListService {
  ...
  /**
   * Destroy all ShoppingLists with those ids.
   *
   * @param {*} ids
   */
  ...
  /**
   * Finds ShoppingLists for Autocomplete.
   *
   * @param {*} search
   * @param {*} limit
   */
  ...
  /**
   * Finds ShoppingLists based on the query.
   *
   * @param {*} args
   */
  ...
  /**
   * Imports a list of ShoppingLists.
   *
   * @param {*} data
   * @param {*} importHash
   */
